/*** Autogenerated by WIDL 6.0-rc3 from msctf.idl - Do not edit ***/
...
interface ITfCandidateListUIElement {
    CONST_VTBL ITfCandidateListUIElementVtbl* lpVtbl;
};
...
/*** ITfUIElement methods ***/
#define ITfCandidateListUIElement_GetDescription(This,description) (This)->lpVtbl->GetDescription(This,description)
#define ITfCandidateListUIElement_GetGUID(This,guid) (This)->lpVtbl->GetGUID(This,guid)
#define ITfCandidateListUIElement_Show(This,show) (This)->lpVtbl->Show(This,show)
#define ITfCandidateListUIElement_IsShown(This,show) (This)->lpVtbl->IsShown(This,show)
/*** ITfCandidateListUIElement methods ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITfCandidateListUIElement_QueryInterface(ITfCandidateListUIElement* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITfCandidateListUIElement_AddRef(ITfCandidateListUIElement* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITfCandidateListUIElement_Release(ITfCandidateListUIElement* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfUIElement methods ***/
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetDescription(ITfCandidateListUIElement* This,BSTR *description) {
    return This->lpVtbl->GetDescription(This,description);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetGUID(ITfCandidateListUIElement* This,GUID *guid) {
    return This->lpVtbl->GetGUID(This,guid);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_Show(ITfCandidateListUIElement* This,BOOL show) {
    return This->lpVtbl->Show(This,show);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_IsShown(ITfCandidateListUIElement* This,BOOL *show) {
    return This->lpVtbl->IsShown(This,show);
}
/*** ITfCandidateListUIElement methods ***/
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetUpdatedFlags(ITfCandidateListUIElement* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetUpdatedFlags(This,pdwFlags);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetDocumentMgr(ITfCandidateListUIElement* This,ITfDocumentMgr **ppdim) {
    return This->lpVtbl->GetDocumentMgr(This,ppdim);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetCount(ITfCandidateListUIElement* This,UINT *puCount) {
    return This->lpVtbl->GetCount(This,puCount);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetSelection(ITfCandidateListUIElement* This,UINT *puIndex) {
    return This->lpVtbl->GetSelection(This,puIndex);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetString(ITfCandidateListUIElement* This,UINT uIndex,BSTR *pstr) {
    return This->lpVtbl->GetString(This,uIndex,pstr);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetPageIndex(ITfCandidateListUIElement* This,UINT *pIndex,UINT uSize,UINT *puPageCnt) {
    return This->lpVtbl->GetPageIndex(This,pIndex,uSize,puPageCnt);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_SetPageIndex(ITfCandidateListUIElement* This,UINT *pIndex,UINT uPageCnt) {
    return This->lpVtbl->SetPageIndex(This,pIndex,uPageCnt);
}
static FORCEINLINE HRESULT ITfCandidateListUIElement_GetCurrentPage(ITfCandidateListUIElement* This,UINT *puPage) {
    return This->lpVtbl->GetCurrentPage(This,puPage);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ITfReadingInformationUIElement, 0xea1ea139, 0x19df, 0x11d7, 0xa6,0xd2, 0x00,0x06,0x5b,0x84,0x43,0x5c)
#endif
#else
...
interface ITfReadingInformationUIElement {
    CONST_VTBL ITfReadingInformationUIElementVtbl* lpVtbl;
};
...
/*** ITfUIElement methods ***/
#define ITfReadingInformationUIElement_GetDescription(This,description) (This)->lpVtbl->GetDescription(This,description)
#define ITfReadingInformationUIElement_GetGUID(This,guid) (This)->lpVtbl->GetGUID(This,guid)
#define ITfReadingInformationUIElement_Show(This,show) (This)->lpVtbl->Show(This,show)
#define ITfReadingInformationUIElement_IsShown(This,show) (This)->lpVtbl->IsShown(This,show)
/*** ITfReadingInformationUIElement methods ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITfReadingInformationUIElement_QueryInterface(ITfReadingInformationUIElement* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITfReadingInformationUIElement_AddRef(ITfReadingInformationUIElement* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITfReadingInformationUIElement_Release(ITfReadingInformationUIElement* This) {
    return This->lpVtbl->Release(This);
}
/*** ITfUIElement methods ***/
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetDescription(ITfReadingInformationUIElement* This,BSTR *description) {
    return This->lpVtbl->GetDescription(This,description);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetGUID(ITfReadingInformationUIElement* This,GUID *guid) {
    return This->lpVtbl->GetGUID(This,guid);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_Show(ITfReadingInformationUIElement* This,BOOL show) {
    return This->lpVtbl->Show(This,show);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_IsShown(ITfReadingInformationUIElement* This,BOOL *show) {
    return This->lpVtbl->IsShown(This,show);
}
/*** ITfReadingInformationUIElement methods ***/
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetUpdatedFlags(ITfReadingInformationUIElement* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetUpdatedFlags(This,pdwFlags);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetContext(ITfReadingInformationUIElement* This,ITfContext **ppic) {
    return This->lpVtbl->GetContext(This,ppic);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetString(ITfReadingInformationUIElement* This,BSTR *pstr) {
    return This->lpVtbl->GetString(This,pstr);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetMaxReadingStringLength(ITfReadingInformationUIElement* This,UINT *pcchMax) {
    return This->lpVtbl->GetMaxReadingStringLength(This,pcchMax);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_GetErrorIndex(ITfReadingInformationUIElement* This,UINT *pErrorIndex) {
    return This->lpVtbl->GetErrorIndex(This,pErrorIndex);
}
static FORCEINLINE HRESULT ITfReadingInformationUIElement_IsVerticalOrderPreferred(ITfReadingInformationUIElement* This,BOOL *pfVertical) {
    return This->lpVtbl->IsVerticalOrderPreferred(This,pfVertical);
}
#endif
#endif
