...
namespace s3d
{
	...
	*/
	...
	public:
		...
		static decltype(MFCreateAttributes)* p_MFCreateAttributes;
		static decltype(MFCreateAsyncResult)* p_MFCreateAsyncResult;
		static decltype(MFInvokeCallback)* p_MFInvokeCallback;
